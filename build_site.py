...
DONE = [
    ...
    {"no": "226", "anchor": "exp226",
     ...
     "title": "ガラスのひびを増やすと、同じつながりの強さでは割れにくくなる（20 本で破片の 17% が動いたのが、80 本では 5%）。80 本なら強さを 0.6 前後に下げる。ただし弱めた条件は、流すたびに割れ方が大きく揺れた（0.6 で 54〜116 個）。計算はどれも 3 秒以内",
     "note": "ガラスのひびを増やすと割れにくくなる。80本なら強さ0.6前後（割れ方は回ごとに揺れる）"},
    ...
    {"no": "232", "anchor": "exp232",
     "tags": ["Karma", "XPU", "速さ", "制作"],
    ...
    {"no": "239", "anchor": "exp239",
     "tags": ["Karma", "速さ", "制作"],
     "log": "log_pm", "thumb": "239_time.png",
     "shots": ["239_time.png", "239_graph.png"],
     "title": "画を 640×360 → 1920×1080（画素 9 倍）にすると、ドーナツは撮る時間が 7.9 倍、海は 2.1 倍。海は 1 枚あたり 9 秒が画の大きさによらない分",
     "note": "解像度9倍で時間はドーナツ7.9倍・海2.1倍"},
    {"no": "240", "anchor": "exp240",
     "tags": ["ツール", "点検"],
     "log": "log_pm", "thumb": "240_summary.png",
     "shots": ["240_summary.png"],
     "title": "211〜239 の点検 — 28 本を流し直して 4,526 個の値を突き合わせた。26 本は一致（時間・足した項目を除く）。値が違ったのは 218・226",
     "note": "211〜239 を流し直し：26 本一致。218・219 は hip の版、226 は割れ方の揺れ"},
    {"no": "241", "anchor": "exp241",
     "tags": ["Karma", "ノイズ除去", "速さ", "制作"],
     "log": "log_pm", "thumb": "241_grid.png",
    ...
    {"no": "247", "anchor": "exp247",
     "tags": ["Karma", "ノイズ除去", "映像", "制作"],
     "log": "log_pm", "thumb": "247_grid.png",
