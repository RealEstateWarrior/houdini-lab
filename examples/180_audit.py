# -*- coding: utf-8 -*-
"""実験180 — 151〜179 の振り返り点検。29本すべてを測り直して、記録と突き合わせる。

30件ごとの点検（030・060・090・121・150 に続いて6回目）。090 までは数件を選んで測り直したが、
...
やり方:
  ...
  4. 控えを元に戻す（記録は変えない）
    ...
    python examples/180_audit.py        （中で hython を呼ぶ）
"""
import glob
import json
import os
...
def main():
    ...
    path = os.path.join(OUT, "180_checks.json")
