...
def main():
    ...
    payload = {
        ...
        "summary":
            ...
            "サンプル数や解像度を下げても、1 枚の時間は大きくは減らなかった（実験221）。\n\n"
            "**訂正（2026-09-24）: はじめは、1 枚目に Karma の立ち上がりの時間が入ったまま測っていた。**そのときは 1400×1600 が 14.5 秒と長く出て、"
            "点を半分にすると 17%・1/4 で 41% 速いと書いた。はじめに小さく 1 枚撮って捨ててから測り直したのが、上の値。画は測り直す前とまったく同じだった。",
        "graph": "", "graph_image": "",
        "comparisons": [
